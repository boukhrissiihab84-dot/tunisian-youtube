// =====================================================================
// TUNISIAN YOUTUBE - APP.JS (BULLETPROOF & DIRECT INTEGRATION)
// =====================================================================
...
// ====== DATA LOADER (SUPER FORCED MULTI-FALLBACK) ======
...
// 🟢 TENTATIVE 1: Direct par variable data.js
if (typeof rawVideosData !== 'undefined' && Array.isArray(rawVideosData)) {
    console.log("✅ data.js detectée directement");
    initApp(rawVideosData);
} else {
    // 🔵 TENTATIVE 2: Fallback par JSON
    console.log("⚠️ data.js non detectée, fallback vers JSON...");
    ...
    fetch(tsUrl, { cache: "no-store" })
        ...
        .catch(() => {
            ...
            if (g) g.innerHTML = "<p style='color:red;text-align:center;grid-column:1/-1'>Error loading videos.</p>";
        });
}
